...
import { FaEdit, FaSave, FaTimes, FaUpload, FaUser, FaEnvelope, FaUserTag, FaGlobe, FaMapMarkerAlt, FaLink, FaPlus } from 'react-icons/fa';
...
const Profile = () => {
  ...
  // Fonction pour formater le solde correctement
    ...
    <div className="profile-container">
      <div className="profile-card">
        ...
        <div className="profile-stats">
          <div className="stat">
            <span className="stat-value">${formatBalance(user.wallet_balance)}</span>
            <span className="stat-label">Wallet Balance</span>
            <button onClick={() => setShowAddFunds(!showAddFunds)} className="btn-add-funds">
              <FaPlus /> Add Funds
            </button>
          </div>
          <div className="stat">
        ...
        {/* Afficher le composant AddFunds si showAddFunds est true */}
        {showAddFunds && (
          <div className="add-funds-section">
            <AddFunds onSuccess={() => setShowAddFunds(false)} />
          </div>
        )}
